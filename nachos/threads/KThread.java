...
public class KThread {
	...
	public static void finish() {
		...
		toBeDestroyed = currentThread;//将当前线程变成将要结束的线程，下一个线程运行的时候自动结束它
...
//		new PingTest(0).run();
	...
	public static void joinTest(){
		...
		//这里考虑一个问题，PingTest中有一句currentThread.yield();是什么意思
	...
	//此处考虑一个问题，waitQueue 到底要不要用static
	private static ThreadQueue waitQueue = ThreadedKernel.scheduler.newThreadQueue(true);// 等待队列
